namespace TreeViewTestsWisej
{
	partial class Page2
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.dataRepeater1.ItemTemplate.AllowDrag = true;
			...
			this.dataRepeater1.ItemTemplate.DragStart += new System.EventHandler(this.dataRepeater1_ItemTemplate_DragStart);
			...
			this.dataRepeater1.DragOver += new Wisej.Web.DragEventHandler(this.dataRepeater1_DragOver);
			// 
			// textBox1
			// 
			...
			// modelBindingSource
			// 
			this.modelBindingSource.DataSource = typeof(TreeViewTestsWisej.Model);
			// 
			// label1
			// 
			...
			this.Name = "Page1";
			this.Size = new System.Drawing.Size(1516, 779);
			this.Text = "Page1";
		...
		private Wisej.Web.BindingSource modelBindingSource;
